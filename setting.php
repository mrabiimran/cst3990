                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                                ...
                                <div class="hero__caption">
                                    ...
                                    <a href="contact.php" class="hero-btn" data-animation="fadeInLeft" data-delay=".3s">Contact Now<i class="ti-arrow-right"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6" >
            ...
            <?php
                    ...
                    if (!empty($row['img']) && file_exists($imagePath)) {
                        echo '<img src="' . $imagePath . '" alt="' . $row['img'] . '" width="100%" style="margin-top: 10px; border-radius: 10px; height:30vh">';
                    } else {
                ...
                <div class="services-cap">
                    <h5><a href="#"><?php echo $row['servicename']; ?></a></h5>
                    <p><?php echo $row['servicedesc']; ?></p>
