...
if (isset($_POST['update'])) {
    ...
    $updateQuery = "UPDATE user SET name='$name', email='$email', contact='$contact', petdetail='$petdetail' WHERE id=$id";
    
    if (mysqli_query($con, $updateQuery)) {
        header("Location: usersdata.php"); // Redirect back to main page
        exit();
    } else {
...
<body id="page-top">
    ...
    <form method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea name="petdetail" class="form-control" required><?php echo $row['petdetail']; ?></textarea>
        </div>
